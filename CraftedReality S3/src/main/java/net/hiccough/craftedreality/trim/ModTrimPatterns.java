...
public class ModTrimPatterns {
    public static final ResourceKey<TrimPattern> HICCOUGH = ResourceKey.create(Registries.TRIM_PATTERN,
            ResourceLocation.fromNamespaceAndPath(CraftedReality.MOD_ID, "hiccough"));

    public static void bootstrap(BootstrapContext<TrimPattern> context) {
        register(context, ModItems.HICCOUGH_SMITHING_TEMPLATE.get(), HICCOUGH);
    }
